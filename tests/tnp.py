...
def test_cli():
    ...
    workflow = ElectronTagNProbeFromNanoAOD(
        ...
        trigger_pt={"HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ": 30, "cutBased >= 2": None},
        tags_pt_cut=35,
        probes_pt_cut=27,
    ...
    assert_arrays_equal(
        ...
        ak.from_parquet("tests/output/sample_1/get_passing_and_failing_probes_1/passing_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_NTuples-part0.parquet"),
    )
    assert_arrays_equal(
        out["get_passing_and_failing_probes_1_hlt"]["sample/1"]["failing"],
        ak.from_parquet("tests/output/sample_1/get_passing_and_failing_probes_1/failing_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_NTuples-part0.parquet"),
    )
    assert_arrays_equal(
        out["get_passing_and_failing_probes_1_hlt"]["sample/2"]["passing"],
        ak.from_parquet("tests/output/sample_2/get_passing_and_failing_probes_1/passing_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_NTuples-part0.parquet"),
    )
    assert_arrays_equal(
        out["get_passing_and_failing_probes_1_hlt"]["sample/2"]["failing"],
        ak.from_parquet("tests/output/sample_2/get_passing_and_failing_probes_1/failing_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_NTuples-part0.parquet"),
    )

    with open("tests/output/sample_1/get_1d_pt_eta_phi_tnp_histograms_1/HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_histos.pkl", "rb") as f:
    ...
    with open("tests/output/sample_2/get_1d_pt_eta_phi_tnp_histograms_1/HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_histos.pkl", "rb") as f:
        histos = pickle.load(f)
    assert_histograms_equal(
    ...
    with open("tests/output/sample_1/get_nd_tnp_histograms_1/HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_histos.pkl", "rb") as f:
        histos = pickle.load(f)
    assert_histograms_equal(
    ...
    assert os.path.exists("tests/output/sample_1/get_nd_tnp_histograms_1/HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_report.json")
    ...
    with open("tests/output/sample_2/get_nd_tnp_histograms_1/HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_histos.pkl", "rb") as f:
        histos = pickle.load(f)
    assert_histograms_equal(
    ...
    assert os.path.exists("tests/output/sample_2/get_nd_tnp_histograms_1/HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_report.json")
